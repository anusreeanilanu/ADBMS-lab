...
INSERT INTO actors (actor, ayear) VALUES('MeDormand', '1957');
SELECT * FROM actors;
...
INSERT INTO acts (actor, title) VALUES('MeDormand', 'Fargo');
INSERT INTO acts (actor, title) VALUES('MeDormand', 'Raising Arizona');
INSERT INTO acts (actor, title) VALUES('MeDormand', 'Wonder Boys');
SELECT * FROM acts;
...
ALTER TABLE movies ADD CONSTRAINT director FOREIGN KEY (director) REFERENCES directors (director) ;
...
USE movie;
SELECT title from movies WHERE director="Coen"AND title in (SELECT title FROM acts WHERE actor="MeDormand");
